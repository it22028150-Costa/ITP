...
const customermodel = require("../models/customerregistermodels");

const router = express.Router();


router.get("/_customer",async(req,res)=>{
...
router.put("/update_customer",async(req,res)=>{
...
router.get("/order_customer/:id", async (req, res) => {
    const id = req.params.id;
...
////Login 
router.post("/login_customer", async (req, res) => {
    console.log('in-------------------------------');
